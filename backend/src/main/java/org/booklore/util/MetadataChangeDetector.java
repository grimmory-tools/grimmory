...
public class MetadataChangeDetector {
    ...
    private static final List<FieldDescriptor<?>> SIMPLE_FIELDS = List.of(
            ...
            new FieldDescriptor<>("openlibraryId",
                    BookMetadata::getOpenlibraryId, BookMetadataEntity::getOpenlibraryId,
                    BookMetadata::getOpenlibraryIdLocked, BookMetadataEntity::getOpenlibraryIdLocked,
                    MetadataClearFlags::isOpenlibraryId, true),
            ...
            new FieldDescriptor<>("applebooksId",
                    BookMetadata::getApplebooksId, BookMetadataEntity::getApplebooksId,
                    BookMetadata::getApplebooksIdLocked, BookMetadataEntity::getApplebooksIdLocked,
                    MetadataClearFlags::isApplebooksId, true),
            new FieldDescriptor<>("applebooksRating",
                    BookMetadata::getApplebooksRating, BookMetadataEntity::getApplebooksRating,
                    BookMetadata::getApplebooksRatingLocked, BookMetadataEntity::getApplebooksRatingLocked,
                    MetadataClearFlags::isApplebooksRating, true),
            new FieldDescriptor<>("applebooksReviewCount",
                    BookMetadata::getApplebooksReviewCount, BookMetadataEntity::getApplebooksReviewCount,
                    BookMetadata::getApplebooksReviewCountLocked, BookMetadataEntity::getApplebooksReviewCountLocked,
                    MetadataClearFlags::isApplebooksReviewCount, true),
