...
public class BookParserConfig {
    ...
    public Map<MetadataProvider, BookParser> parserMap(GoogleParser googleParser, AmazonBookParser amazonBookParser,
                                                       GoodReadsParser goodReadsParser, HardcoverParser hardcoverParser, ComicvineBookParser comicvineBookParser, DoubanBookParser doubanBookParser, RanobeDbParser ranobedbParser, LubimyCzytacParser lubimyczytacParser, AudibleParser audibleParser, BolBookParser bolBookParser) {
        return Map.of(
                ...
                MetadataProvider.Bol, bolBookParser
        );
    }
}
