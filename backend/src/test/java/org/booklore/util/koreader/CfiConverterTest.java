...
class CfiConverterTest {
    ...
    class RangeCfiTests {
        ...
        // Range CFI round-trip and compact-form tests are covered in EpubCfiServiceTest,
        // since the epub4j CfiConverter library does not support range CFI parsing directly.
        // EpubCfiService wraps the library and adds range CFI decomposition.
