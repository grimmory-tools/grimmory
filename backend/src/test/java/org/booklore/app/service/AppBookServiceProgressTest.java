...
class AppBookServiceProgressTest {
    ...
    void updateBookProgress_success_delegatesToBookServiceWithPathBookId() {
        ...
        request.setFileProgress(new BookFileProgress(1L, "pos", "href", 0.5f, null, null, null, null, null, null, null));
    ...
    void updateBookProgress_success_mapsAllFieldsFromAppRequest() {
        ...
        UpdateProgressRequest request = new UpdateProgressRequest();
        request.setFileProgress(new BookFileProgress(1L, null, null, 0.75f, null, null, null, null, null, null, null));
    ...
    void updateBookProgress_nonAdminWithoutAccess_throwsForbidden() {
        ...
        UpdateProgressRequest request = new UpdateProgressRequest();
        request.setFileProgress(new BookFileProgress(1L, null, null, 0.5f, null, null, null, null, null, null, null));
