...
export class MetadataAdvancedFetchOptionsComponent implements OnChanges {
  ...
  fields: (keyof FieldOptions)[] = [
    ...
    'itunesId', 'itunesRating', 'itunesReviewCount'
  ];
  ...
  providers: string[] = ['Amazon', 'Google', 'GoodReads', 'Hardcover', 'Comicvine', 'Douban', 'Lubimyczytac', 'Ranobedb', 'Audible', 'Itunes'];
  providersWithClear: string[] = ['Clear All', 'Amazon', 'Google', 'GoodReads', 'Hardcover', 'Comicvine', 'Douban', 'Lubimyczytac', 'Ranobedb', 'Audible', 'Itunes'];
  ...
  formatLabel(field: string): string {
    const fieldLabels: Record<string, string> = {
      ...
      'itunesReviewCount': 'iTunes Review Count',
